#!/usr/bin/env python3
"""
Full Uber Reviews Processing Script
==================================
Processes the complete Uber Eats customer reviews dataset for Wing Shack.

Usage:
python3 scripts/process_full_uber_reviews.py
"""
...
print("🚀 Processing Full Uber Eats Reviews Dataset...")
...
def process_uber_reviews():
    """Process the complete Uber reviews CSV file"""
        ...
        with open(input_file, 'r', encoding='utf-8') as file:
            ...
            for row in reader:
                ...
                intake_metadata = {
                    ...
                    "platform": "uber_eats",
                    "data_batch": "uber_reviews_full_2024"
                }
    ...
    if results:
        ...
        reviews_with_comments = len([r for r in results if r['review_text'] and len(r['review_text']) > 20])
        print(f"   - Reviews with detailed comments: {reviews_with_comments}")
        
        # City breakdown
        cities = {}
        for record in results:
            city = record['raw_content'].get('city', 'Unknown')
...
def generate_clean_csv(results):
    ...
    filename = 'data/uber_reviews_full_clean.csv'
...
def main():
    print("🎯 Big Appetite OS - Full Uber Reviews Processing")
    print("=================================================\n")
