-- =====================================================
-- FIX ARRAY CASTING ERRORS
-- Migration 038: Force update functions with correct array handling
-- =====================================================

-- =====================================================
-- FORCE DROP AND RECREATE QUANTUM DECODER
-- =====================================================

-- Drop all versions of the function
DROP FUNCTION IF EXISTS actors.decode_signal_quantum(TEXT, TEXT, JSONB, UUID);
DROP FUNCTION IF EXISTS actors.decode_signal_quantum(TEXT, TEXT, JSONB);
DROP FUNCTION IF EXISTS actors.decode_signal_quantum(TEXT, TEXT);
DROP FUNCTION IF EXISTS actors.decode_signal_quantum(TEXT);

-- Recreate with correct array handling
...
BEGIN
  ...
  LOOP
    ...
    -- Check language patterns (higher weight) - FIXED ARRAY HANDLING
    ...
    -- Check behavioral indicators (medium weight) - FIXED ARRAY HANDLING
    ...
    -- Check friction indicators (lower weight, but important) - FIXED ARRAY HANDLING
...
-- =====================================================
-- FORCE DROP AND RECREATE SIMPLIFIED DECODER
-- =====================================================

-- Drop all versions
DROP FUNCTION IF EXISTS actors.decode_signal_simple(TEXT, TEXT);
DROP FUNCTION IF EXISTS actors.decode_signal_simple(TEXT);
